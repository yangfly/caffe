#ifndef CAFFE_UTIL_SSD_TRANSFORMER_HPP
#define CAFFE_UTIL_SSD_TRANSFORMER_HPP
...
class SSDTransformer {
 public:
  explicit SSDTransformer(const TransformationParameter& param, Phase phase);
  virtual ~SSDTransformer() {}
...
#endif  // CAFFE_UTIL_SSD_TRANSFORMER_HPP
